  ...
  return (
    <div className="w-11/12 mx-auto">
      <div className="flex flex-row">
        ...
        <button className="btn ml-10 text-primary-content rounded-md"
        onClick={ () =>{
          setLocalSort("");
          setGroupSort("");
          setDepartmentSort("");
        ...
        <div className="flex flex-row w-full my-auto ">
          <div className="join mx-auto my-2">
            <button
              ...
              className={`join-item btn text-primary-content ${page == 0 ? "btn-disabled" : ""} `}
            >
              «
            </button>
            <button className="join-item btn text-primary-content">Page {page + 1}</button>
            <button
              onClick={() => {
              ...
              className={`join-item btn text-primary-content ${!isSuccess
                  ? ""
                  : data.status == 404
                    ? "btn-disabled"
                    : data.data.length !== 10
