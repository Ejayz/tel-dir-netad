...
export function RemoveLocalModal({
    FetchList, local }: {
        FetchList: any, local: number
    }) {
    const RemoveLocal = useRef<HTMLDialogElement>(null);
    return (
        <>
                    ...
                    <Formik
                        ...
                        onSubmit={async (values, action) => {
                            ...
                            let response = await fetch(
                                "/api/authenticated/local/remove_local",
                                {
                                    method: "POST",
                                    body: bodyContent,
                                    headers: headersList,
